# ABGames - Complete Gaming Portal

Welcome to ABGames! A collection of browser-based games with profile tracking, achievements, and progression.
...
## 🚀 How to Launch on Nobara Linux

### Option 1: Double-click (Recommended)
1. Navigate to the ABGames folder in your file manager
2. Double-click `index.html`
3. It should open in your default browser (Firefox)
...
### Option 3: Firefox Directly
```bash
firefox index.html
```

### Option 4: Local Web Server (Best for development)
```bash
# Using Python 3 (pre-installed on Nobara)
cd /path/to/ABGames
...
**⚠️ Important:** Clearing browser data will erase your profile! Use the Export feature to back up.
